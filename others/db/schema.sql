...
-- -----------------------------------------------------
-- Table `scholarmesh`.`grp_is_about`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `scholarmesh`.`grp_is_about` ;

CREATE TABLE IF NOT EXISTS `scholarmesh`.`grp_is_about` (
  `grp_id` INT UNSIGNED NOT NULL,
  `subj_name` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `scholarmesh`.`ppr_is_about`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `scholarmesh`.`ppr_is_about` ;

CREATE TABLE IF NOT EXISTS `scholarmesh`.`ppr_is_about` (
  `ppr_id` INT UNSIGNED NOT NULL,
  `subj_name` VARCHAR(45) NOT NULL,
