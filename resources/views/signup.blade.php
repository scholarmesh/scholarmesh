            ...
            <div class="col-md-7 col-lg-8">
                ...
                <form action="/signup" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <label for="bio" class="form-label">About you<span class="text-muted"> (Optional)</span></label>
                    ...
                    <button class="w-100 my-4 btn btn-primary btn-lg" type="submit">Register</button>
                </form>

                <div class="row justify-content-center">
                    <div class="col-auto mt-4 mb-5">
                        <a href="/login" class="fs-5">Already have an account? Log in.</a>
                    </div>
                </div>
            </div>
        </div>
